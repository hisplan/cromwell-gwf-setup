...
```bash
wget https://github.com/hisplan/cromwell-gwf-setup/archive/refs/tags/v0.1.7.tar.gz
```
...
```bash
curl -L -o cromwell-gwf-setup-0.1.7.tar.gz  -H "Authorization: token xyz-123-abc"  https://github.com/hisplan/cromwell-gwf-setup/archive/refs/tags/v0.1.7.tar.gz
```

Decompress:

```bash
tar xvzf cromwell-gwf-setup-0.1.7.tar.gz --strip-components=1
```
